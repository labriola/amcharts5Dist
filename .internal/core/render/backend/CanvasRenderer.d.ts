/** @ignore */ /** */
import { IRenderer, IContainer, IDisplayObject, IGraphics, IRendererEvents, IMargin, IText, ITextStyle, IRadialText, IPicture, IRendererEvent, ILayer, ICanvasOptions, BlendMode, IPointerEvent, Id } from "./Renderer.js";
...
import { ArrayDisposer, DisposerClass, IDisposer, CounterDisposer } from "../../util/Disposer.js";
/**
 * @ignore
 */
...
export declare class CanvasRenderer extends ArrayDisposer implements IRenderer, IDisposer {
    ...
    protected _domWidth: number;
    protected _domHeight: number;
